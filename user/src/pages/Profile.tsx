  ...
  return (
    <div className="px-4 py-6">
      ...
      <div className="mt-6 grid gap-3">
        {user.phone && (
          <div className="flex items-center gap-3 rounded-lg bg-white p-4 ring-1 ring-gray-100">
      ...
      <button
        onClick={logout}
        className="mt-6 flex w-full items-center justify-center gap-2 rounded-lg border border-gray-200 py-3 text-sm font-medium text-gray-600"
      >
